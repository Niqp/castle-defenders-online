...
export const WAVE_CONFIG = {
  ...
  MAX_ENEMIES_PER_LANE: 20, // Increased cap
  ...
  LAST_SCALING_WAVE: 60, // Wave where enemy type progression completes
  FALLBACK_ENEMY: { 
    baseHealth: 10, 
    baseDamage: 2 
  },
...
export const GAME_BALANCE = {
  ...
  STARTING_GOLD: 10, // Reduced from 10 to 5 - very tight start
  STARTING_FOOD: 5, // Reduced from 5 to 2 - forces careful early choices
...
export const WORKER_TYPES = {
  ...
  Digger:   { costs: { gold: 300 },  outputs: { gold: 8 },   sprite: 'digger.png' },
  Excavator:{ costs: { gold: 700 },  outputs: { gold: 25 },   sprite: 'excavator.png' },
  
  // Food generation - significantly reduced efficiency and higher costs
  Farmer:   { costs: { gold: 50 },   outputs: { food: 0.5 },   sprite: 'farmer.png' },
  Hunter:   { costs: { gold: 300 },  outputs: { food: 4 },   sprite: 'hunter.png' },
  Rancher:  { costs: { gold: 700 },  outputs: { food: 15 },   sprite: 'rancher.png' },
};
...
export const UNIT_TYPES = {
  ...
  Archer: { costs: { gold: 85, food: 35 }, hp: 35, dmg: 18, sprite: 'archer.png' },
  
  // Late game unit - very expensive
  Knight: { costs: { gold: 250, food: 75 }, hp: 140, dmg: 12, sprite: 'knight.png' },
  
  // Support unit - heals all friendly units each tick during battle
  Priest: { costs: { gold: 200, food: 50 }, hp: 50, dmg: 3, healAmount: 15, sprite: 'priest.png' },
  
  // Magic unit - attacks all enemy units in the same cell
  Mage: { costs: { gold: 220, food: 60 }, hp: 45, dmg: 10, attacksAll: true, sprite: 'mage.png' },
};
...
export const ENEMY_TYPES = {
  ...
  orc:       { baseHealth: 100, baseDamage: 16, sprite: 'orc.png' },
  
  // Late enemies (waves 30-80)
  troll:     { baseHealth: 160, baseDamage: 25, sprite: 'ogre.png' },
  
  // Ultra late enemies (waves 60+)
  berserker: { baseHealth: 280, baseDamage: 35, selfHealPercent: 0.5, sprite: 'berserk.png' },
  warlord:   { baseHealth: 450, baseDamage: 30, attacksAll: true, sprite: 'warlord.png' },
};
...
export const UPGRADE_TYPES = {
  MINING_EFFICIENCY: {
    ...
    levels: [
      ...
      { level: 4, cost: { gold: 2500, food: 0 }, effect: { mineGoldAmount: 8 } },
      { level: 5, cost: { gold: 5000, food: 0 }, effect: { mineGoldAmount: 15 } },
    ]
  },
  ...
  WORKER_PRODUCTIVITY: {
    ...
    levels: [
      ...
      { level: 2, cost: { gold: 650, food: 90 }, effect: { workerMultiplier: 1.4 } },
      { level: 3, cost: { gold: 1250, food: 220 }, effect: { workerMultiplier: 1.6 } },
      { level: 4, cost: { gold: 3500, food: 500 }, effect: { workerMultiplier: 1.8 } },
      { level: 5, cost: { gold: 7000, food: 1250 }, effect: { workerMultiplier: 2.0 } },
    ]
  },
  ...
  EFFICIENT_MINING: {
    ...
    category: 'workers',
    levels: [
      { level: 1, cost: { gold: 260, food: 25 }, effect: { goldWorkerCostReduction: 0.85 } },
      { level: 2, cost: { gold: 700, food: 70 }, effect: { goldWorkerCostReduction: 0.7 } },
      { level: 3, cost: { gold: 2000, food: 180 }, effect: { goldWorkerCostReduction: 0.55 } },
    ]
  },
  ...
  EFFICIENT_FARMING: {
    ...
    category: 'workers',
    levels: [
      { level: 1, cost: { gold: 350, food: 35 }, effect: { foodWorkerCostReduction: 0.85 } },
      { level: 2, cost: { gold: 700, food: 90 }, effect: { foodWorkerCostReduction: 0.7 } },
      { level: 3, cost: { gold: 1500, food: 220 }, effect: { foodWorkerCostReduction: 0.55 } },
    ]
  },
  ...
  UNIT_ARMOR: {
    ...
    category: 'military',
    levels: [
      { level: 1, cost: { gold: 620, food: 100 }, effect: { unitHealthMultiplier: 1.25 } },
      { level: 2, cost: { gold: 1200, food: 250 }, effect: { unitHealthMultiplier: 1.5 } },
      { level: 3, cost: { gold: 3000, food: 625 }, effect: { unitHealthMultiplier: 1.75 } },
      { level: 4, cost: { gold: 7000, food: 1500 }, effect: { unitHealthMultiplier: 2.0 } },
      { level: 5, cost: { gold: 18000, food: 3750 }, effect: { unitHealthMultiplier: 2.25 } },
    ]
  },
  ...
  WEAPON_ENHANCEMENT: {
    ...
    levels: [
      ...
      { level: 2, cost: { gold: 850, food: 200 }, effect: { unitDamageMultiplier: 1.4 } },
      { level: 3, cost: { gold: 2600, food: 500 }, effect: { unitDamageMultiplier: 1.6 } },
      { level: 4, cost: { gold: 6000, food: 1250 }, effect: { unitDamageMultiplier: 1.8 } },
      { level: 5, cost: { gold: 15000, food: 3000 }, effect: { unitDamageMultiplier: 2.0 } },
    ]
  },
  ...
  RECRUITMENT_EFFICIENCY: {
    ...
    category: 'military',
    levels: [
      { level: 1, cost: { gold: 600, food: 125 }, effect: { unitCostReduction: 0.9 } },
      { level: 2, cost: { gold: 1700, food: 375 }, effect: { unitCostReduction: 0.8 } },
      { level: 3, cost: { gold: 5000, food: 900 }, effect: { unitCostReduction: 0.7 } },
    ]
  },
  ...
  CASTLE_FORTIFICATION: {
    ...
    category: 'castle',
    levels: [
      { level: 1, cost: { gold: 1650, food: 200 }, effect: { castleMaxHpIncrease: 200 } },
      { level: 2, cost: { gold: 3650, food: 500 }, effect: { castleMaxHpIncrease: 400 } },
      { level: 3, cost: { gold: 8000, food: 1250 }, effect: { castleMaxHpIncrease: 600 } },
      { level: 4, cost: { gold: 15000, food: 3000 }, effect: { castleMaxHpIncrease: 800 } },
      { level: 5, cost: { gold: 30000, food: 7500 }, effect: { castleMaxHpIncrease: 1000 } },
    ]
  },
  ...
  CASTLE_REPAIRS: {
    ...
    category: 'castle',
    levels: [
      { level: 1, cost: { gold: 1800, food: 250 }, effect: { castleRegenRate: 8 } },
      { level: 2, cost: { gold: 3800, food: 625 }, effect: { castleRegenRate: 16 } },
      { level: 3, cost: { gold: 8000, food: 1500 }, effect: { castleRegenRate: 24 } },
    ]
  },
  ...
  CRITICAL_STRIKES: {
    ...
    category: 'military',
    levels: [
      { level: 1, cost: { gold: 1800, food: 300 }, effect: { critChance: 0.1 } },
      { level: 2, cost: { gold: 3800, food: 750 }, effect: { critChance: 0.2 } },
      { level: 3, cost: { gold: 8000, food: 2000 }, effect: { critChance: 0.3 } },
    ]
  },
  ...
  OVERCHARGE: {
    ...
    category: 'mining',
    levels: [
      { level: 1, cost: { gold: 1650, food: 650 }, effect: { miningFoodRatio: 0.25 } },
      { level: 2, cost: { gold: 3650, food: 1650 }, effect: { miningFoodRatio: 0.5 } },
